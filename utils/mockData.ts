...
export const mockAudiobooks: Audiobook[] = [
  {
    ...
    coverImage: 'https://images.pexels.com/photos/3394939/pexels-photo-3394939.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    duration: 345, // 5:45
  ...
  },
  {
    ...
    coverImage: 'https://images.pexels.com/photos/3652898/pexels-photo-3652898.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    duration: 180, // 3:00
    createdAt: new Date('2025-03-28'),
    updatedAt: new Date('2025-03-29'),
    status: 'completed',
    voiceId: 'v2',
    textContent: 'Today I embarked on a journey that would change my life forever...',
  ...
  },
  {
    ...
    status: 'draft',
    textContent: 'Recent advances in quantum computing have shown promising results...'
  }
];
...
export const mockAudioEffects: AudioEffect[] = [
  {
    ...
    name: 'Gentle Piano',
    category: 'music',
    previewUrl: 'https://actions.google.com/sounds/v1/ambiences/relaxing_ambience.ogg'
  },
  {
    id: 'e2',
    name: 'Rainy Day',
  ...
  },
  {
    ...
    category: 'ambient',
    previewUrl: 'https://actions.google.com/sounds/v1/ambiences/forest_night.ogg'
  },
  {
    id: 'e5',
    name: 'Meditation',
  ...
  },
  {
    ...
    name: 'Stream',
    category: 'ambient',
    previewUrl: 'https://actions.google.com/sounds/v1/water/stream_water_flowing.ogg'
  },
  {
    id: 'e8',
    name: 'Birds',
    category: 'sound_effect',
    previewUrl: 'https://actions.google.com/sounds/v1/animals/birds_multiple_singing.ogg'
  }
];
